...
def test_eval_1(rng):
    ...
    _assert_db(db, "gpm:aaa::ipm::beta", np.array(0.4, dtype=np.float64))
    _assert_db(db, "gpm:bbb::ipm::beta", np.array(0.3, dtype=np.float64))
    _assert_db(db, "gpm:aaa::ipm::gamma", np.array(0.1, dtype=np.float64))
    _assert_db(db, "gpm:bbb::ipm::gamma", np.array(0.1, dtype=np.float64))
    _assert_db(db, "gpm:aaa::ipm::xi", np.array(0.0, dtype=np.float64))
    _assert_db(db, "gpm:bbb::ipm::xi", np.array(1 / 90, dtype=np.float64))
    _assert_db(db, "meta::ipm::beta_bbb_aaa", np.array(0.2, dtype=np.float64))

    _assert_db(db, "gpm:aaa::init::population", np.array([100, 200], dtype=np.int64))
    _assert_db(db, "gpm:bbb::init::population", np.array([300, 400], dtype=np.int64))

    _assert_db(db, "gpm:aaa::mm::population", np.array([100, 200], dtype=np.int64))
    _assert_db(db, "gpm:bbb::mm::population", np.array([300, 400], dtype=np.int64))

    _assert_db(db, "gpm:aaa::mm::phi", np.array(40.0, dtype=np.float64))
    _assert_db(db, "gpm:bbb::mm::phi", np.array(33.0, dtype=np.float64))
...
def test_eval_2(rng):
    ...
    _assert_db(db, "gpm:bbb::ipm::beta", np.array(0.5, dtype=np.float64))
...
def test_eval_param_function_2(rng):
    ...
    _assert_db(db, "gpm:aaa::ipm::xi", expected_aaa)
...
def test_eval_param_function_chained(rng):
    ...
    _assert_db(db, "gpm:aaa::ipm::beta", np.array(0.4))
    _assert_db(db, "gpm:aaa::ipm::gamma", np.array(0.1))
