"""
Implements `NBSimulator`: an epymorph simulation algorithm for performing single run,
forward simulations with mixture gamma-poisson distributed events.
"""
...
from nb_ipm_exec import CustomIPMExecutor
...
class NBSimulator(Generic[RUMEType]):
    """
    ...
    def run(
        ...
        with error_gate("compiling the simulation", SimCompilationError):
            ipm_exec = CustomIPMExecutor(rume, world, data, rng)
