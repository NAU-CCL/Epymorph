...
class BaseFilter(ABC):
    ...
    Attributes:
        params (Dict[str, Any]): Parameters for the filter.
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        Args:
            **kwargs: Arbitrary keyword arguments representing filter parameters.
        """
    ...
    def run(self, *args, **kwargs: Any) -> ParticleFilterOutput:
        ...
        Args:
            **kwargs: Arbitrary keyword arguments needed to run the filter.
