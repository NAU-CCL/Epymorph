...
from epymorph.simulator.basic.basic_simulator import BasicSimulator
from nb_sim import NBSimulator

class MultiSimulatorNB:
    """
    A simulator for running multiple realizations of a RUME simulation.
    """

    def run(self, rume, num_realizations, initial_values, param_values):
        """
        ...
        for i_realization in range(num_realizations):
            ...
            sim = NBSimulator(rume_temp)
            out_temp = sim.run(rng_factory=default_rng(i_realization))
