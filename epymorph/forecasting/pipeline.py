...
from epymorph.forecasting.filter_plot import PlotRendererPipelineMixin
...
from epymorph.util import DateValueType, mask
...
@dataclass(frozen=True)
class PipelineOutput(PlotRendererPipelineMixin):
    """
