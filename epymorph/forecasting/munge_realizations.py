...
class RealizationSelection(RealizationStrategy): 
    ...
    def agg(self,agg: RealizationAggMethod|List[RealizationAggMethod])->RealizationAggregation: 
        return RealizationAggregation(self.num_realizations,self.selection,agg)
...
class RealizationSelector: 
    ...
    def all(self)->RealizationSelection: 
        ...
        """
        return RealizationSelection(self._num_realizations, np.arange(self._num_realizations))
    
    def sample(self,*,rng,size)->RealizationSelection: 
        """
