...
def _fetch_cases(attrib_name: str, scope: CensusScope, time_frame: TimeFrame) -> NDArray[np.float64]:
    """
    ...
    """
    if time_frame.start_date < date(2022, 2, 24) or time_frame.end_date > date(2023, 5, 4):
...
def _fetch_facility_hospitalization(attrib_name: str, scope: CensusScope, time_frame: TimeFrame) -> NDArray[np.float64]:
    ...
    """
    if time_frame.start_date < date(2020, 12, 13) or time_frame.end_date > date(2023, 5, 10):
...
def _fetch_state_hospitalization(attrib_name: str, scope: CensusScope, time_frame: TimeFrame) -> NDArray[np.float64]:
    """
...
def _fetch_vaccination(attrib_name: str, scope: CensusScope, time_frame: TimeFrame) -> NDArray[np.float64]:
    """
    ...
    """
    if time_frame.start_date < date(2020, 12, 13) or time_frame.end_date > date(2024, 5, 10):
...
def _fetch_deaths_county(attrib_name: str, scope: CensusScope, time_frame: TimeFrame) -> NDArray[np.float64]:
    """
    ...
    """
    if time_frame.start_date < date(2020, 1, 4) or time_frame.end_date > date(2024, 4, 5):
...
def _fetch_deaths_state(attrib_name: str, scope: CensusScope, time_frame: TimeFrame) -> NDArray[np.float64]:
    """
...
def _api_query(info: QueryInfo, fips: NDArray, time_frame: TimeFrame, granularity: CensusGranularityName) -> DataFrame:
    """
