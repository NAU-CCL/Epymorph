...
class DataTypeTest(unittest.TestCase):
    ...
    def test_dtype_check(self):
        ...
        self.assertFalse(dtype_check([('x', int), ('y', int)], 1))
        self.assertFalse(dtype_check([('x', int), ('y', int)], 78923.1))
        self.assertFalse(dtype_check([('x', int), ('y', int)], "hi"))
        self.assertFalse(dtype_check([('x', int), ('y', int)], ()))
        self.assertFalse(dtype_check([('x', int), ('y', int)], (1, 237.8)))
        self.assertFalse(dtype_check([('x', int), ('y', int)], (1, 2, 3)))
