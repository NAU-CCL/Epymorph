...
class TestHypercubeWorld(EpymorphTestCase):
    ...
    def test_construct(self):
        ...
        self.assertNpEqual(self._initials, world.get_local_array())
    ...
    def test_travel_1(self):
        ...
        self.assertNpEqual(world.get_local_array(), self._initials - np.array([30, 15]))

        # And added those individuals at time index 2
        self.assertNpEqual(world.ledger[2, :, :, :], travelers)
    ...
    def test_travel_2(self):
        ...
        # We should have removed that many individuals from home
        self.assertNpEqual(world.get_local_array(), self._initials - np.array([90, 45]))

        # And added individuals at time index 2 and 3
        self.assertNpEqual(world.ledger[2, :, :, :], travelers * 2)
        self.assertNpEqual(world.ledger[3, :, :, :], travelers)
